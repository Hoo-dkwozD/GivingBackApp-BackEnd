...
from models.CharityActivity import CharityActivity
from models.CharityActivityTag import CharityActivityTag
...
class Recommender:
    ...
    def get_recommendations(cls, id: int) -> REST_Response:
        ...
        for idx, row in activity_df.iterrows():
            ...
            row["keywords"] = ' '.join(list(title_key_words_dict_scores.keys()) + row["tags"] + list(desc_key_words_dict_scores.keys()))
